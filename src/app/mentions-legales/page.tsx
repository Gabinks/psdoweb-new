...
export async function generateMetadata(){
    return generatePageMetadata({
        ...
        description: "Consultez les mentions légales de PSDOweb. Informations sur l'entreprise, propriété intellectuelle, protection des données et conditions d'utilisation du site.",
        keywords: ["mentions légales", "informations légales", "propriété intellectuelle", "protection des données", "RGPD", "conditions d'utilisation"]
    })
}
    ...
    return (
        <>
            <main className={"flex flex-col items-center gap-20"}>
                ...
                <div
                    className={"bg-white py-5 px-10 shadow-inner drop-shadow flex flex-col items-center gap-5 mx-5 sm:mx-0"}>
                ...
                <div className={"py-10 flex flex-col items-center gap-10"}>
                    ...
                    <Category title={"Hébergeur du site"} anchor={"hoster"}>
                        ...
                        <Item primary={"Adresse de l'hébergeur"}
                              secondary={"2 rue Kellermann - 59100 Roubaix - France"}/>
                        <Item primary={"Numéro de téléphone de l'hébergeur"} secondary={"Non référencé."}/>
                    </Category>
                    <CategorySecond anchor={"property"} title={"Propriété intellectuelle"}
                                    description={"L'intégralité du contenu du site PSDOweb est protégée par les lois françaises et internationales relatives à la propriété intellectuelle. Tous les droits de reproduction sont réservés, y compris les documents téléchargeables et les représentations iconographiques et photographiques."}/>
                    <CategorySecond anchor={"condition"} title={"Condition d'utilisation"}
                    ...
                    <CategorySecond anchor={"protection"} title={"Protection des données personnelles"}
                                    description={"Conformément à la loi Informatique et Libertés du 6 janvier 1978 modifiée, vous disposez d’un droit d’accès, de rectification, de modification et de suppression des données vous concernant. Vous pouvez exercer ce droit en envoyant un courrier à l'adresse suivante : 2A rue de l'Orangerie, 60000 Beauvais ou par email à baptiste.petit@psdoweb.com ."}/>
                    <CategorySecond anchor={"cookie"} title={"Cookies"}
                                    description={"Le site PSDOweb peut être amené à vous demander l’acceptation des cookies pour des besoins de statistiques et d'affichage. Un cookie est une information déposée sur votre disque dur par le serveur du site que vous visitez. Il contient plusieurs données qui sont stockées sur votre ordinateur dans un simple fichier texte auquel un serveur accède pour lire et enregistrer des informations."}/>
                </div>
            </main>
        </>
    )
