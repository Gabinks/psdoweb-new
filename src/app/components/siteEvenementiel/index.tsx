...
export default function SiteEvenementiel() {
  return (
    <section className="bg-white p-8 rounded-lg shadow-md flex justify-between items-center flex-row below-xg:flex-col below-xg:items-start">
        <div>
            <h3 className="text-4xl font-bold mb-2 below-xg:text-3xl">Site Événementiel</h3>
            <p className=" mb-2 font-bold text-xl">
            Un site web dédié à un événement 
            </p>
        ...
        <div className="text-right below-xg:text-left">
            ...
            <p className="text-2xl font-bold mb-4 whitespace-nowrap below-lg:text-xl">Entre 1 000 € et 7 000 €</p>
            <Link href={{
                pathname: "/contact", // La page de destination
                query: { source: "Evenementiel" }, // Paramètre envoyé à la page
                }}
