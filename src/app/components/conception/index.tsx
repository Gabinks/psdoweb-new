    ...
    return (
        <div className="flex flex-col justify-center items-center ">
            ...
            <div className="flex sm:hidden flex-col justify-center items-center">
                ...
                <Image src={"/images/icons/triangle.svg"} alt="triangle conception" className="ml-5" width="62" height="47" />
            ...
            <Image className='hidden sm:block' src={'/images/conception/conception.png'} alt='Conception de site internet' width={800} height={800} />
        </div>
    );
}
