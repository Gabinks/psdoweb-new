...
export default function Contact() {
    ...
    return (
        <>
            <div className={"py-32"}>
                <div
                    className="relative w-full bg-custom-image bg-no-repeat bg-cover bg-bottom h-screen flex flex-col justify-center items-center mx-auto below-lg:p-2"
                    style={{maxWidth: "calc(100% - 110px)"}}>
                    <div
                        className="flex flex-row items-center justify-between gap-20 relative z-10 below-lg:flex-col below-lg:gap-1 below-lg:mt-4 below-lg:mb-4">
                        <Image src={"/images/logo/logo.svg"} alt="Logo" className=' below-xg:hidden' width={342}
                               height={200}/>

                        <form onSubmit={handleSubmit}
                              className='w-full max-w-md gap-6 flex flex-col p-6 form below-xg:max-w-xs mx-auto below-lg:p-2 '
                              id='formulaire'>
                            ...
                            <label className="text-xs flex items-start">
                                <input
                                    ...
                                    required
                                />
                                <p>J&apos;accepte que mes données soient mémorisées dans l&apos;unique but d&apos;être
                                    recontacté</p>
                            </label>
