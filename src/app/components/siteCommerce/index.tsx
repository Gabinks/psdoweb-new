...
export default function SiteCommerce() {
  return (
    <section className="bg-white p-8 rounded-lg shadow-md flex justify-between items-center flex-row below-xg:flex-col below-xg:items-start">
        <div>
            <h3 className="text-4xl font-bold mb-2  below-xg:text-3xl">Site E-commerce</h3>
            <p className=" mb-2 font-bold text-xl">
            Un site permettant de vendre des produits ou des services en ligne. 
            </p>
          ...
          <div className="text-right below-xg:text-left">
            ...
            <p className="text-2xl font-bold mb-4 whitespace-nowrap below-lg:text-xl">Entre 2 500 € et 15 000 €</p>
            <Link href={{
                pathname: "/contact", // La page de destination
                query: { source: "E-commerce" }, // Paramètre envoyé à la page
                }}
