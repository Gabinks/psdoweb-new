    ...
    return (
        <main className={"flex flex-col items-center gap-20"}>
            ...
            <div className={"bg-white py-5 px-10 w-72 xl:w-[30vw] shadow-inner drop-shadow flex flex-col gap-5 mx-5 sm:mx-0"}>
                <h4 className={"text-xl xl:text-3xl font-bold self-center"}>Sommaire des articles</h4>
                <ul className={"list-decimal text-base sm:text-lg xl:text-2xl flex flex-col gap-3"}>
                    <li>
                    ...
                    <li>
                        <Link href={"#3"} className={"flex items-center justify-between group hover:underline"}>Accès au
                            site <Image
                                src={"/images/icons/arrow.png"} alt={"fleche"} width={20} height={20}
                                className={"group-hover:translate-x-1.5 transition-transform"}/></Link>
                    </li>
                    <li>
                        <Link href={"#4"} className={"flex items-center justify-between group hover:underline"}>Collecte de
                            données <Image
                                src={"/images/icons/arrow.png"} alt={"fleche"} width={20} height={20}
                                className={"group-hover:translate-x-1.5 transition-transform"}/></Link>
                    </li>
                    ...
                    <li>
                        <Link href={"#8"} className={"flex items-center justify-between group hover:underline"}>Cookie <Image
                            src={"/images/icons/arrow.png"} alt={"fleche"} width={20} height={20}
                            className={"group-hover:translate-x-1.5 transition-transform"}/></Link>
                    </li>
                    <li>
